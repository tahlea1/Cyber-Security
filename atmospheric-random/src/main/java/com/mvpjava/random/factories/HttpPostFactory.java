...
public class HttpPostFactory {
	...
	public static final int DEFAULT_MAX_RANDOM_RANGE = 100000; /*modified to be 6 digits long */
	public static final boolean DEFAULT_UNIQUE_VALUES = true; /* known as repeatable */
	public static final int DEFAULT_BASE = 10; /*as it is converted in the redback 2fa config class */
